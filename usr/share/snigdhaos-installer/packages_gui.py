...
from packages import Packages #icon-cr
...
def gui(self, Gtk, vbox_stack, fn):
    ...
    try:
        ...
        rb_export_all = Gtk.RadioButton.new_with_label_from_widget(None, "All Installed Packages")
        ...
        grid_pacmanlog.attach_next_to(label_grid_padding_right,pacmanlog_scrolledwindow,Gtk.PositionType.RIGHT,1,1,)

        vbox_pacmanlog.pack_start(grid_pacmanlog, False, False, 0)

        button_install_packages = Gtk.Button(label="Install Packages")

        gui_parts = (vbox_stack,grid_package_status,grid_package_count,vbox_pacmanlog,textbuffer_pacmanlog,textview_pacmanlog,label_package_status,label_package_count,)

        button_export_packages.connect("clicked",self.on_click_export_packages,packages_obj,rb_export_all,rb_export_explicit,gui_parts,)

        button_install_packages.connect("clicked",self.on_click_install_packages,packages_obj,gui_parts,)
